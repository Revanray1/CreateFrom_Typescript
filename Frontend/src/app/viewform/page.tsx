  ...
  {(userData) ? (
    <div className="h-full bg-blue-500 py-4 rounded-md px-3">
      <div className="grid grid-cols-2 gap-4 bg-white min-h-10 border ">
        ...
        <div className="text-center border-l-2  border-grey">
          {userData.firstName}
        </div>
      </div>
      <div className="grid grid-cols-2 gap-4  bg-white  min-h-10 border">
      ...
      <div className="grid grid-cols-2 gap-4  bg-white  min-h-10 border ">
        ...
        <div className="text-center overflow-x-auto border-l-2  border-grey">
          {userData.phoneNumber}
        </div>
      </div>
      <div className="grid grid-cols-2 gap-4  bg-white  min-h-10 border">
        <div className="text-center font-bold">Email </div>
        <div className="text-center truncate hover:text-clip border-l-2  border-grey">
          {userData.email}
        </div>
      </div>
      ...
      {userData.education.length > 0 && (
        <div className="grid grid-cols-2 gap-4 min-h-52 bg-white h-52 border">
          ...
          <div className="text-center border-l-2  border-grey overflow-scroll no-scrollbar">
                ...
                <div className="m-6 " key={index + "edu"}>
                  ...
                  <div className="overflow-x-scroll no-scrollbar">
                    ...
                    <div className="grid grid-cols-2 gap-4 mx-16">
                      ...
                      <div>{data.joinedOnYear}</div>
                    </div>
                    <div className="grid grid-cols-2 gap-4 mx-16">
                      <div className="font-bold">To </div>{" "}
                      <div>{data.completedYear}</div>
                    </div>
                  </div>
                </div>
              </>
              ...
              <>
                <div className="m-6" key={index + "work"}>
                  ...
                  <div className="overflow-x-scroll no-scrollbar">
                    ...
                    <div className="grid grid-cols-2 gap-4 mx-16">
                      <div className="font-bold">From</div>{" "}
                      <div>{data.workJoinedYear}</div>
                    </div>
                    <div className="grid grid-cols-2 gap-4 mx-16">
                      <div className="font-bold">To </div>{" "}
                      <div>{data.workRelievedYear}</div>
                    </div>
                  </div>
                </div>
              </>
