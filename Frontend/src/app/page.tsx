        ...
        <div
          ...
          <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12 ">
            <div
              ...
              <h3 className='font-kanit text-center  text-xl text-bold text-slate-200 m-2'>Welcome to Home Page</h3>


            </div>
            <div className='text-center'>
              <div className='font-sofadi_one text-2xl text-slate-200 '> Create Your Form Or Review your Form Here</div>
            </div>
            <div
