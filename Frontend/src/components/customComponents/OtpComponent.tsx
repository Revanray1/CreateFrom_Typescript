      ...
      <div className="container mx-auto">
        <div className="">
          <div className="w-full">
            <div className="mb-2">
              {errorMessage !== "" && (
                <div className="text-center text-white block">
                  {errorMessage}
                </div>
              )}
            </div>
            <div className="animation">
              <div className="bg-white  py-3 rounded text-center otp-lg-screen-2560-container-width otp-sm-screen-320-width">
                    ...
                    <>
                      ...
                      {timeLeft <= 60 ? (
                        ...
                        >
                          <span
                            className={`font-bold ${
                              isDisabled ? "text-red-500" : "text-blue-700"
                            }`}
                          >
                            {isDisabled
