...
const EmailComponent: React.FC<EmailcomponentProps> = ({
  ...
  return (
    <div className='h-56 bg-white p-8 rounded-lg shadow-lg ' ><form className="space-y-4 h-full">
      <div className="grid  gap-4">
        <div>
          <h1 className=' text_top_animation font-kanit text-lg sm:text-sm md:text-2xl lg:text-2xl 2xl:text-6xl text-[#484957] font-bold text-center'>{SIGN_IN}</h1>
          <label htmlFor="firstName" className="font-kanit text-start text-bold">Enter Your Email</label>
